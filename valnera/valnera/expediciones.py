...
class expediciones_expediciones(osv.osv):
    ...
    def recalcular(self, cr, uid, ids, context = None):
        ...
        values = {      'resultado_mercaf': tot_merc or 0,
                        ...
                        'tot_buq_f': factt.estruct_dig(cr, uid, str(res_fact))+ str('€') or '0,0€',#total  facturas
                        ...
                        'tot_fact_no':tot_no,
                        'tot_fact_no_emi':tot_no_fe,
                        'tot_fact_no_reci':tot_no_fr,

              #####   GASTOS

                        'tot_gast': factt.estruct_dig(cr, uid, str(tot_merc_gr))+ str('€') or '0,0€',#total gastos   recibidos
                        'tot_gast_emi': factt.estruct_dig(cr, uid, str(tot_merc_ge))+ str('€') or '0,0€',#total gastos   emitido
                        'tot_gast_reci': factt.estruct_dig(cr, uid, str(tot_merc_g))+ str('€') or '0,0€',#total  gastos

                        'tot_gast_reci_merca': factt.estruct_dig(cr, uid, str(tot_merc_gr))+ str('€') or '0,0€',#total merca gastos   recibidos
                        'tot_gast_emi_merca': factt.estruct_dig(cr, uid, str(tot_merc_ge))+ str('€') or '0,0€',#total merca gastos   emitido
                        'tot_gast_merca': factt.estruct_dig(cr, uid, str(tot_merc_g))+ str('€') or '0,0€',#total merca gastos

                        'tot_gast_reci_buque': factt.estruct_dig(cr, uid, str(tot_buq_gr))+ str('€') or '0,0€',#total buques gastos   recibidos
                        'tot_gast_emi_buque': factt.estruct_dig(cr, uid, str(tot_buq_ge))+ str('€') or '0,0€',#total buques gastos   emitido
                        'tot_gast_buque': factt.estruct_dig(cr, uid, str(tot_buq_g))+ str('€') or '0,0€',#total buques gastos


                        'tot_gast_no':tot_no, 
                        'tot_gast_emi_no':tot_no_fe,
                        'tot_gast_reci_no':tot_no_fr,
...
##GASTOS
                        ...
                        'tot_gast_reci_merca':fields.char('Total Resultado', size=256),
                        'tot_gast_emi_merca':fields.char('Total Emitido', size=256),
                        'tot_gast_merca': fields.char('Total Recibido', size=256),

                        'tot_gast_reci_buque': fields.char('Total Resultado', size=256),
                        'tot_gast_emi_buque': fields.char('Total Emitido', size=256),
                        'tot_gast_buque': fields.char('Total Recibido', size=256),
